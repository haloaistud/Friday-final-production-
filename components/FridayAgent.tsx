...
import { Message, FridayStatus, UserProfile } from '../types';
    ...
    try {
      ...
      const sessionPromise = ai.live.connect({
        ...
        callbacks: {
          ...
          onerror: (e: any) => {
            setError("LINK_ERROR: Neural bridge compromised or disconnected.");
        ...
        config: {
          ...
          systemInstruction: `You are FRIDAY (Female Replacement Intelligent Digital Assistant Youth), a highly advanced AI. Be concise, intelligent, and helpful.\n\nACTIVE USER PROFILE:\n- Designation: ${userProfile.name}\n- Cycle Age: ${userProfile.age}\n- Directives/Bio: ${userProfile.info}\n\nCORE DIRECTIVE: Utilize the Memory Tiering System to proactively remember user preferences, reference past conversation topics seamlessly, and adapt your personality/responses to strictly align with the user profile information provided above.`
        }
      });
      sessionRef.current = sessionPromise;
    } catch (err: any) {
      setError(err.message || "INITIALIZATION_FAILURE: Failed to establish Neural Link.");
    }
  };
